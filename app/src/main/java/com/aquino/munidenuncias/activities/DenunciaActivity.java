...
public class DenunciaActivity extends AppCompatActivity {
    private static final String TAG = DenunciaActivity.class.getSimpleName();
    EditText titulo, comentario, ubicacion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titulo = (EditText)findViewById(R.id.titulo_input);
        comentario = (EditText)findViewById(R.id.comentario_input);
        ubicacion = (EditText)findViewById(R.id.ubicacion_input);
    ...
    public void callRegister(View view) {
        ...
        String comentario1 = comentario.getText().toString();
        Double ubicacion1 = Double.parseDouble(ubicacion.getText().toString());


        if (titulo1.isEmpty() || comentario1.isEmpty()) {
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createDenuncia(titulo1, comentario1, ubicacion1, ubicacion1, user.getId());
        } else {
            ...
            RequestBody titulo = RequestBody.create(MultipartBody.FORM, titulo1);
            RequestBody coment = RequestBody.create(MultipartBody.FORM, comentario1);
            RequestBody ubi1 = RequestBody.create(MultipartBody.FORM, ubicacion.getText().toString());
            RequestBody ubi2 = RequestBody.create(MultipartBody.FORM, ubicacion.getText().toString());
            RequestBody user_id = RequestBody.create(MultipartBody.FORM, user.getId().toString());

            call = service.createDenunciaWithImage(titulo, coment, ubi1,ubi2,user_id , imagenPart);
        }
            ...
            public void onResponse(Call<ResponseMessage> call, Response<ResponseMessage> response) {
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        Toast.makeText(DenunciaActivity.this, responseMessage.getMessage(), Toast.LENGTH_LONG).show();
                        finish();
